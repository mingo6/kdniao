...
namespace Sobyte\KDNiao;

/**
 * 快递鸟SDK库
 * @package Sobyte\KDNiao\Libs
 */
class KDNiao
{
     ...
     * @return array
     */
    public function __construct($app_id, $app_key, $production = true)
    {
        $this->appId = $app_id;
        $this->appKey = $app_key;
        ...
        if ($production) {
            ...
            $this->subUrl = 'http://testapi.kdniao.cc:8081/api/dist';
            $this->orderUrl = 'http://testapi.kdniao.com:8081/api/EOrderService';
        }
    }
     ...
     * @return array $result
     */
    public function getOrderTraces($ShipperCode, $LogisticCode, $production = true)
    {
        $requestData = [
            'OrderCode' => '',
